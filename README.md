# Vibe Data Engineering with Databricks Assistant

Welcome to the **Vibe Data Engineering Workshop**! In this hands-on tutorial, you'll use the **Databricks Assistant** — the AI coding assistant built right into your Databricks workspace — to build a complete data pipeline from raw CSV ingestion to curated gold-layer tables, Genie spaces, and dashboards.
...
> **Why Databricks Assistant?** Everything happens in your browser — no CLI installs, no API keys, no local tooling. You use the workspace UI for setup tasks (creating schemas, volumes, uploading data) and the Databricks Assistant in notebooks to generate pipeline code. It's the fastest way to go from zero to a working pipeline.
...
4. [Enabling Databricks Assistant](#4-enabling-databricks-assistant)
...
- **Databricks Assistant** enabled in your workspace (enabled by default on most workspaces)
...
## 4. Enabling Databricks Assistant

Databricks Assistant is the AI coding assistant built into notebooks, the SQL editor, and other workspace surfaces. It should be enabled by default.
...
> **Not seeing the Assistant?** Ask your workspace admin to enable it under **Settings** > **Workspace settings** > **Databricks Assistant**.

---

## 5. Choose Your Tutorial

Pick an industry and follow the step-by-step tutorial. Each tutorial contains 9 exercises that guide you through building a complete data pipeline using the workspace UI and Databricks Assistant.
...
| **Pipeline** | 4. Bronze layer, 5. Silver layer, 6. Gold layer | Databricks Assistant |
| **Execution** | 7. Create & run the pipeline | Workspace UI |
| **Analytics** | 8. Create Genie spaces, 9. Create dashboards | Workspace UI + Databricks Assistant |

---

> **Vibe Data Engineering with Databricks Assistant** — everything in your browser, nothing to install.
>
